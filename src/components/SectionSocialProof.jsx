  ...
  return (
    <Section id="social-proof" className="bg-white">
      <Container className="text-center">
        <div className="mb-16">
          <h2 className="text-4xl font-bold text-textMain mb-4">TESTIMONIALS</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            <motion.div 
              ...
              className="bg-offWhite p-8 rounded-2xl border border-gray-100 flex flex-col text-left"
            >
              <div className="text-brandBlack mb-6">
